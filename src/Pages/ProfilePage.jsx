...
export default function ProfilePage() {
  const [profileImage, setProfileImage] = useState(
    "https://tse1.mm.bing.net/th?id=OIP.q10JcSV8pb4VJV_RW6MzvwHaHa&pid=Api&P=0&h=180"
  );
        ...
        <div className="bg-gray-100 p-8 flex flex-col position-relative h-full">
          ...
          <div className="relative flex">
            ...
            <div className="mt-4 ml-6">
              <h2 className="text-[25px] font-bold text-gray-800">Random Name</h2>
              <p className="text-gray-600 text-[20px]">something@gmail.com</p>
            </div>
          </div>
          {/* Description */}
